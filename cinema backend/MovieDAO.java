...
public class MovieDAO {
    ...
    public int insertMovie(Movie movie) {
    	String query = "INSERT INTO movies (title, category, cast, director, producer, synopsis, " +
                "reviews, trailer_picture, trailer_video, mpaa_rating) " +  // Changed _url to match getters
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        int movieId = -1;
        ...
        try (Connection connection = DatabaseConnection.getConnection();
            ...
            preparedStatement.setString(8, movie.gettrailer_picture());
            preparedStatement.setString(9, movie.gettrailer_video());
