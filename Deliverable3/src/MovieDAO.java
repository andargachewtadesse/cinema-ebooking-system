...
public class MovieDAO {
    ...
    private Movie mapResultSetToMovie(ResultSet resultSet) throws SQLException {
        ...
        movie.setTrailerPicture(resultSet.getString("trailer_picture_url"));
        movie.setTrailerVideo(resultSet.getString("trailer_video_url"));
        movie.setMpaaRating(resultSet.getString("mpaa_rating"));
        
        // Initialize showTimes and load them from the database
